...
PLUS_TWO = Card(
    ...
    bustable=False,
    score_priority=2,
    score_modifier=lambda score: score + 2,
)
PLUS_FOUR = Card(
    name="+4",
    abbrv="+4",
    ...
    bustable=False,
    score_priority=2,
    score_modifier=lambda score: score + 4,
)
PLUS_SIX = Card(
    name="+6",
    abbrv="+6",
    ...
    bustable=False,
    score_priority=2,
    score_modifier=lambda score: score + 6,
)
PLUS_EIGHT = Card(
    name="+8",
    abbrv="+8",
    ...
    bustable=False,
    score_priority=2,
    score_modifier=lambda score: score + 8,
)
PLUS_TEN = Card(
    name="+10",
    abbrv="+10",
    ...
    bustable=False,
    score_priority=2,
    score_modifier=lambda score: score + 10,
)
TIMES_TWO = Card(
    name="x2",
    abbrv="X",
